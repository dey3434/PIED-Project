...
if (all(file.exists(csvfiles))) {
  ...
  fit_grow <- stan(file = 'stancode/model_9.stan', data = pied_dat, 
                   iter = 5000,
                   warmup = 1000,
                   chains = 3, cores = 8, 
...
write.csv(beta.summaries, "betasummaries_model9_threechain_PIED.csv", row.names = FALSE)
...
##### 
save(p.o.df, file = here::here("results", "model-9-pred-obs.RData"))
...
p_pred_vs_observed <- ggplot(p.o.df, aes(predicted, observed)) + 
  ...
  ylim(0, 10) + xlim(0,10)
p_pred_vs_observed
ggsave(here::here("images", "model_9", "pred_vs_observed.png"), p_pred_vs_observed)
...
save(ll, r_eff, leaveoneout, file = here::here("results", "model-9-loo.RData"))
...
ggsave(here::here("images", "model_9", "ppc-plot-1.png"),
       ppc1, width = 16/3, height = 9)
ggsave(here::here("images", "model_9", "ppc-plot-2.png"),
       ppc2, width = 16/3, height = 9)
ggsave(here::here("images", "model_9", "ppc-plot-3.png"),
