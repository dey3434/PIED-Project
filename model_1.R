...
if (all(file.exists(csvfiles))) {
  ...
  fit_grow <- stan(file = 'stancode/model_1.stan', data = pied_dat, 
                   iter = 5000,
                   warmup = 1000,
                   chains = 3, cores = 8, 
...
plotdata <- select(fit_grow_df, all_of(yrep_keep))
...
##### 
save(p.o.df, file = here::here("results", "model-1-pred-obs.RData"))
...
save(ll, r_eff, leaveoneout, file = here::here("results", "model-1-loo.RData"))
...
ggsave(here::here("images", "model_1", "ppc-plot-1.png"),
       ppc1, width = 16/3, height = 9)
ggsave(here::here("images", "model_1", "ppc-plot-2.png"),
       ppc2, width = 16/3, height = 9)
ggsave(here::here("images", "model_1", "ppc-plot-3.png"),
