...
fit_grow <- readRDS("ppt_tmp_monsoon_winter.RDS")
library(rstan)
...
newclimate <- read.csv(url("https://de.cyverse.org/dl/d/B972CA3B-AB96-47C3-B9DE-A79CD215D408/pied_all_tmean_ppt.csv"))
